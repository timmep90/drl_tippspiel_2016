...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-mini"><b>DrL</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg">Dr. Lüpkes GbR </span>
    </a>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
                @include('layouts.partials.clock')
                ...
                @else
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="{{asset('/img/tippspiel/DrL-160x160.png')}}" class="user-image" alt="User Image"/>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    {{ Auth::user()->name }}
                                    <small>{{Auth::user()->user_type->name}}</small>
                                </p>
                            </li>
                            <!-- Menu Footer-->
